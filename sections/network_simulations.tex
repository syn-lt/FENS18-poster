...
\begin{overpic}[width=\columnwidth]%
  ...
  \put(52,28){\normalfont \textbf{B}}
\end{overpic}
\captionof{figure}{In detailed network simulations the synaptic lifetime and weight distributions are shaped by the overall ratio of synaptic potentiation and depression $D$. \label{fig:netwsim}}
\vspace{2.3cm}
