...
\begin{minipage}{\columnwidth}
  We found the variance $\sigma_b^2$ of the additive component to have little effect on both the lifetime and spine size distributions. Interestingly however, the bias in the additive change affects both distributions significantly. A bias towards increases in size ($\mu_b > 0$) moves the tail of the lifetime distribution towards higher lifetimes (Fig.~\ref{fig:lifemub}A) and shifts the mean of the spine size distribution towards higher values (Fig.~\ref{fig:lifemub}B). 
